globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-Dv_88Ob1.js","assets/layout-segment-context-B3T0Td3U.js"];
...
function getDraftSecret() {
	return "a3d8c53a-d32e-49a2-8fa4-bb19eaf394fd";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "9d6c9dc7-3c90-4bc7-8f01-dc54203f6aba";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "9d6c9dc7-3c90-4bc7-8f01-dc54203f6aba") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "9d6c9dc7-3c90-4bc7-8f01-dc54203f6aba",
		rootBoundaryId
	});
}
/**
